    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function reBuild(resizing){
            ...
            windowsHeight = document.documentElement.clientHeight;  //updating global var
        ...
        */
        ...
        function scrollHandler(){
            ...
            if(!options.autoScrolling || options.scrollBar){
                ...
                var screen_mid = currentScroll + (document.documentElement.clientHeight / 2.0);
                var isAtBottom = $body.height() - document.documentElement.clientHeight === currentScroll;
        ...
        */
        function isCompletelyInViewPort(movement){
            ...
            if(movement == 'up'){
                return bottom >= ($window.scrollTop() + document.documentElement.clientHeight);
            }
